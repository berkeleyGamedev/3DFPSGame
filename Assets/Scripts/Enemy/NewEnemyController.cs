...
public class NewEnemyController : MonoBehaviour
{
    ...
    public void DecreaseHealth(float amount)
    {
        ...
        if (p_curHealth <= 0)
        {
            ...
            if (Random.value < m_PowerPillDropRate)
            {
                Instantiate(m_PowerPill, transform.position, Quaternion.identity);
            }
